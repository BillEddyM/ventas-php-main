...
$cartas = [
    ...
    ["titulo" => "Total ventas", "icono" => "fa fa-money-bill", "total" => "Q.".calcularTotalVentas($ventas), "color" => "#2A8D22"],
    ["titulo" => "Productos vendidos", "icono" => "fa fa-box", "total" =>calcularProductosVendidos($ventas), "color" => "#223D8D"],
    ["titulo" => "Ganancia", "icono" => "fa fa-wallet", "total" => "Q.". obtenerGananciaVentas($ventas), "color" => "#D55929"],
];
